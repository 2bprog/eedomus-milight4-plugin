...
Un brige Mi-Light v4 installé et configuré.
...
* IP + Port du bridge V4 : IP adresse et port (sous la forme x.x.x.x:yyyy) de votre brige Mi-Light v4, par défaut le port est 8899 
